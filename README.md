...
The new customers transfer existing customers need one month. Therefore, I included 4 weeks of data after the campaign in consideration. And I calculated the average customer growth in each campaign. Combined with total revenue (even if Campaign C was the highest in total revenue) and ROI calculation, Campaign A had the highest ROI so I will conclude that Campaign A was the most cost-effective at driving customer growth.
...
-  **User’s Behaviors Data, Website Data (Page views, unique visitors, conversion rate, time spent on site),
  and Social Media Engagement (Likes, shares, comments)**
